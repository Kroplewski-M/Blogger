...
<template>
    <!-- Edit blog -->
    <div class="max-w-[1000px] mx-auto mt-16 text-center flex flex-col">
        ...
        <div v-if="!preview" class="w-[100%] overflow-hidden">
            ...
            class="bg-[#222222] rounded-lg mt-10 h-[300px] md:w-[1000px] min-w-[350px] focus:outline-none text-gray-200 pl-[10px] pt-[10px] font-semibold"></textarea>
        </div>
        <!-- Preview Blog -->
