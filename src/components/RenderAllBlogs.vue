        ...
        <div v-for="blog in blogStore.blogs">
            <div class="w-[300px] md:w-[350px] h-[400px] bg-[#222222] hover:bg-[#333333] rounded-md relative overflow-hidden hover:cursor-pointer mx-auto md:mx-0">
                <div class="md:w-[300px] w-[250px] mx-auto">
                    <img :src='blog.imageUrl' alt="" class="rounded-md mt-[10px] md:w-[290px] md:h-[150px]">
                </div>
                ...
                <div class="absolute -bottom-3">
                    <div class="flex">
                        ...
                        <p class="text-gray-300 ml-[5px] font-semibold">{{blog.authorName}}</p>
                    </div>
                    <p class="-mt-[4px] ml-[5px] text-gray-500">{{blog.created_at}}</p>
                </div>
